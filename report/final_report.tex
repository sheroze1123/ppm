...
We have implemented an \nbody{} simulator using the Particle-Mesh model in \cpp{} and a simulation visualizer in Python. In this chapter, we discuss the implementation of both the simulator and visualizer.
