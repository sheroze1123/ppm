...
//   2. `p_valid` is set to all true
//   3. `p_pos` is set uniformally at random between `pos_min` and `pos_max`
//   4. `p_mass` is set uniformally at random between `mass_min` and `mass_max`
